...
def drink():
  ...
  if (wantDrink < 2):
    ...
    #adds the drink to the final order list
    ...
    #if the user didn't want a drink:
    total_cost()
    #tells the user their order cost so far
    welcome()
...
def ketchup():
  print("\n  Ketchup ($0.25 each)")
  #tells the user the cost of ketchup
  ketchup = int(input("How many ketchup packets would you like? Enter the number here."))
  #asks the user how many ketchup packets they would like, and sets the ketchup local varible to that value
  print("You added " + str(ketchup) + " ketchup packets for $" + str(ketchup * 0.25) + ".")
  #tells the user how many ketchup packets they ordered and how much they cost
  ...
  welcome()
  #allows the user to add more items to order
def total_cost():
  total_cost = 0
